...
- DonвЂ™t use require statements for your templates or styles, use styleUrls and templateUrls, the angular2-template-loader plugin will change it to require at build time.
- DonвЂ™t use default exports.
- DonвЂ™t use form.controls.controlName, use form.get(вЂcontrolNameвЂ™)
- DonвЂ™t use control.errors?.someError, use control.hasError(вЂsomeErrorвЂ™)
