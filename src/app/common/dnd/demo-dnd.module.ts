...
const dndComponents = [SimpleDndComponent, ZoneDndComponent, CustomDataDndComponent,
    CustomFunctionDndComponent, ShoppingBasketDndComponent];
const sortableComponents = [SimpleSortableComponent, MultiSortableComponent, RecycleMultiSortableComponent,
    EmbeddedSortableComponent, SimpleSortableCopyComponent];

@NgModule({
    imports: [BrowserModule, FormsModule, DndModule.forRoot(), PanelModule],
